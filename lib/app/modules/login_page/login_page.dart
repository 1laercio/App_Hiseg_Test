...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    ...
    final controllerLocalization = context.read<LocalizationService>();
    controller.addListener(() {
      if (controller.status == StatusLogin.falha) {
        ScaffoldMessenger.of(context).showSnackBar(
          ...
          controllerLocalization.status == StatusLocalization.sucesso) {
        Navigator.push(
          context,
    ...
    return Scaffold(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        ButtonWidegt(
            ...
            onPressed: () async {
              Users login = Users(
                  cpf: txCPFController.text,
                  password: txPasswordController.text);
